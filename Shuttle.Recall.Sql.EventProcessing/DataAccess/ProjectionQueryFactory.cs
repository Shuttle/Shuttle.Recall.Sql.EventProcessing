...
namespace Shuttle.Recall.Sql.EventProcessing
{
	public class ProjectionQueryFactory : IProjectionQueryFactory
	{
	    ...
	    {
		    _sqlEventProcessingOptions = Guard.AgainstNull(Guard.AgainstNull(sqlEventProcessingOptions, nameof(sqlEventProcessingOptions)).Value, nameof(sqlEventProcessingOptions.Value));
